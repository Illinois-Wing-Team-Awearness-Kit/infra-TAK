...
>
> **Origin:** Moved from `PLAN-v0.9.27-alpha.md` (2026-05-16) to make room for the v0.9.26 Authentik stability work (tasklog purge regression, request-cancellation storm, sustained 80% server CPU surfaced on tak-10 immediately after the v0.9.25-alpha release). The DataSync mission lifecycle investigation that previously held v0.9.26 has moved to v0.9.27, and this Node-RED scope moves another slot to v0.9.28. Originally moved from v0.9.23 → v0.9.24 (2026-05-14) → v0.9.25 → v0.9.26 → v0.9.27 → v0.9.28 (all 2026-05-16). Node-RED scope is unchanged across all moves.
...
- `nodered/flows.json`
- `docs/NODERED.md`
- `docs/RELEASE-v0.9.28-alpha.md` (new, planned)
...
_Plan moved from v0.9.23 → v0.9.24 (2026-05-14) → v0.9.25 → v0.9.26 → v0.9.27 → v0.9.28 (all 2026-05-16). Original Node-RED scope unchanged._
