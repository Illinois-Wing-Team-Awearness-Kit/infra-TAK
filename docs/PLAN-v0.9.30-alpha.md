...
> **Status:** DRAFT
> **Target:** v0.9.30-alpha
> **Scope:** Node-RED ArcGIS geometry handling fix for multipart polygon features (outer rings only).
>
> **Origin:** Moved from `PLAN-v0.9.29-alpha.md` (2026-05-17) to make room for v0.9.29-alpha "Security audit touch-up" (CRIT-08 SSH host-key pinning across 9 guarddog watchdog scripts + CRIT-07 eval cleanup + atakatak nag + CSP unsafe-eval drop + audit-response doc — response to the 2026-04 Oblivion Edge / Project Shakespear audit). Originally moved from v0.9.23 → v0.9.24 (2026-05-14) → v0.9.25 → v0.9.26 → v0.9.27 → v0.9.28 → v0.9.29 → v0.9.30 (all 2026-05-16/17). Node-RED scope is unchanged across all moves.
...
- `nodered/flows.json`
- `docs/NODERED.md`
- `docs/RELEASE-v0.9.30-alpha.md` (new, planned)
...
_Plan moved from v0.9.23 → v0.9.24 (2026-05-14) → v0.9.25 → v0.9.26 → v0.9.27 → v0.9.28 (2026-05-16) → v0.9.29 (2026-05-17 for enterprise Authentik PG scaling) → v0.9.30 (2026-05-17 for security audit touch-up). Original Node-RED scope unchanged._
