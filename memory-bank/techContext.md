...
- Single `VERSION = "X.Y.Z-alpha"` constant near the top of `app.py` (currently `0.9.18-alpha` — **on `dev` 2026-05-13, ship-blocked LDAP routing repair hotfix awaiting tak-10 validation**).
