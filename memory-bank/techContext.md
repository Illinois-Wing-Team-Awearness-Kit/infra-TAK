...
- Single `VERSION = "X.Y.Z-alpha"` constant near the top of `app.py` (currently `0.9.18-alpha` — **released to `main` 2026-05-13, validated on tak-10**).
